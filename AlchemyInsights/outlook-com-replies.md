...
**設定** > **檢視所有的 Outlook 設定** > **郵件** > **自動回覆**若要開啟 [您的[自動回覆設定](https://outlook.live.com/mail/options/mail/automaticReplies)。
2. 選取 [**開啟自動回覆**切換。
