...
- 若要保留組織中的所有信箱，您可以遵循[下列步驟](https://docs.microsoft.com/office365/securitycompliance/retention-policies#applying-a-retention-policy-to-an-entire-organization-or-specific-locations)使用 Office 365 保留原則。 請注意，整個組織的保留原則，新的使用者將會自動指派給原則。
