...
若要解決此問題，請設定工作流程以傳送電子郵件，但不超過[Exchange Online 寄件者限制](https://docs.microsoft.com/office365/servicedescriptions/exchange-online-service-description/exchange-online-limits#recipientlimits)。 例如，在工作流程中使用 pause，將電子郵件傳送至 Microsoft 365 群組、通訊群組或啟用郵件功能的安全性群組，或一次傳送郵件給少於200個收件者。
