...
如需使用 Office 準備工具套件的詳細資訊，請參閱 Use the the the the the the the the the the the the the the the the the [365 application](https://docs.microsoft.com/DeployOffice/readiness-toolkit-application-compatibility-microsoft-365-apps)
