...
如果您無法登入您的 Outlook.com、Hotmail、Live 或 MSN 電子郵件帳戶, 或是不確定如何登入或登出,[以下是一些解決方案](https://go.microsoft.com/fwlink/p/?linkid=2005840)。
  
如果您仍有登入的問題, 請參閱[您何時無法登入您的 Microsoft 帳戶](https://go.microsoft.com/fwlink/p/?linkid=837479)。