...
當封存信箱啟用 Microsoft 365 時，您可以使用 **EDiscovery 搜尋和匯出** ，以在主要和封存信箱中探索內容。 如需使用 **EDiscovery 搜尋匯出** 來尋找該內容的詳細資訊，請遵循 [這裡](https://docs.microsoft.com/microsoft-365/compliance/export-search-results)所述的步驟。
