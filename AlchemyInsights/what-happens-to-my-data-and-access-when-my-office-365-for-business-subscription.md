...
- 如果**定期計費**已開啟，您不需要採取任何動作。 您的訂閱將會以**週期性的計費**日期計費，而且會根據您目前的付款頻率，向您收取額外一年或一月的費用。 如果您因任何原因而關閉了**週期性的帳單**，您可以永遠[開啟定期計費](https://docs.microsoft.com/microsoft-365/commerce/subscriptions/renew-your-subscription#turn-recurring-billing-off-or-on)。
