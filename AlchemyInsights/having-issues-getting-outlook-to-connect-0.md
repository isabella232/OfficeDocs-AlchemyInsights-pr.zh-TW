...
ms.locfileid: "32400389"
---
# <a name="having-issues-getting-outlook-to-connect"></a>有取得 Outlook 連線問題嗎？

我們已偵測到 Outlook 未設定為在下列網域下正常運作：
  
{HealthCheckString}
  
NS 或 CNAME 記錄的網域 (DNS) 設定不正確設定。 您可以如需詳細指示，請參閱[在 Office 365 中](https://support.office.com/article/Create-DNS-records-for-Office-365-when-you-manage-your-DNS-records-B0F3FDCA-8A80-4E8E-9EF3-61E8A2A9AB23.aspx)的更新 DNS 記錄。 
