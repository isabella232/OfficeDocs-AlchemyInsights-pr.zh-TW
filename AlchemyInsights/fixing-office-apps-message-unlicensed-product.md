...
- 檢查您的防火牆、防毒軟體和 Proxy 設定，確認其沒有封鎖 Office App 存取網際網路。 若要深入了解，請參閱 [Office 365 URL 和 IP 位址範圍](https://docs.microsoft.com/office365/enterprise/urls-and-ip-address-ranges "Office 365 URL 和 IP 位址範圍") (英文)。

- 檢查您的防火牆、防毒軟體和 Proxy 設定，確認其沒有封鎖 Office App 存取網際網路。 若要深入了解，請參閱 [Office 365 URL 和 IP 位址範圍](https://docs.microsoft.com/office365/enterprise/urls-and-ip-address-ranges) (英文)。
...
- 開啟 Office App，並 [[登出]](https://support.office.com/article/5a20dc11-47e9-4b6f-945d-478cb6d92071) 任何現有的使用者帳戶。 [[移除]](https://docs.microsoft.com/microsoft-365/admin/manage/remove-licenses-from-users?view=o365-worldwide "移除") 並 [[重新指派]](https://docs.microsoft.com/microsoft-365/admin/manage/assign-licenses-to-users?view=o365-worldwide "重新指派") Office 授權，然後使用受影響的使用者帳戶 [[登入 Office]](https://support.office.com/article/628ea040-f265-49de-b986-be09c3ebf8a9 "登入 Office")。
...
[啟用 Office 時，發生「很抱歉，我們無法連線至您的帳戶。 請稍後再試一次」錯誤](https://docs.microsoft.com/office/troubleshoot/activation-installation/issue-when-activate-office-from-office-365啟用 Office 時，發生「很抱歉，我們無法連線至您的帳戶。 請稍後再再試一次」錯誤)