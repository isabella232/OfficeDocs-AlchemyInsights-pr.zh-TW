...
---
# <a name="reduce-junk-email-in-your-inbox"></a>減少垃圾郵件收件匣中

如果您看到垃圾郵件數量增加，請繼續閱讀如何[協助防止收件匣收到垃圾郵件](https://go.microsoft.com/fwlink/p/?linkid=873140)。
  
如果您收到的電子郵件，看起來像垃圾郵件，您可以透過以滑鼠右鍵按一下 [郵件報告，然後選取 [**標記為垃圾郵件**。 
  
當您將郵件標示為垃圾郵件時，可改善 Outlook.com 中的垃圾郵件篩選器。 您也可以封鎖的電子郵件地址和您不想要接收郵件的網域。
