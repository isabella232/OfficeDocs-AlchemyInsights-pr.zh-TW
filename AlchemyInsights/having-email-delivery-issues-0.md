...
網域 (DNS) 設定中的 NS 或 MX 記錄設定不正確，導致電子郵件無法正確傳送到 Microsoft。 若要詳細指示，請參考[在任一 DNS 主機服務提供者建立 DNS 記錄](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider) (英文)。
