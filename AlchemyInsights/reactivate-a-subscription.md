...
2. 選擇您要重新啟用的訂閱。 在 [帳單] 區段中，選取 [**重新**啟用]。

    如果您未看到 [**重新**啟用] 做為可用的動作，請[致電支援人員](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products)重新啟用您的訂閱。
