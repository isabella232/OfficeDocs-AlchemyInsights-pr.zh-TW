...
- 查看您的訂閱狀態是否已過期。
- 請確定您有允許用戶端授權的訂閱，例如 Microsoft 365 應用程式的商務用帳戶或商務版，並[確保使用者已指派授權](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/assign-licenses-to-users)。 
