...
ms.locfileid: "29460674"
---
# <a name="submit-dynamics-365-support-requests"></a>提交 Dynamics 365 支援要求

如果您是**Microsoft Dynamics 客戶參與**客戶請送出到新的[Power 平台系統管理中心](https://admin.powerplatform.microsoft.com/?ref=officemodern)您票證。
  
新的入口網站提供更多直接路徑最適合 Dynamics 客戶參與和其他進階平台產品的協助支援。
