...
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>在檔案總管中開啟的 SharePoint 文件庫

1. 瀏覽到在 Internet Explorer 10 或 Internet Explorer 11 文件庫。 
    
2. 按一下右上方，在 [檢視] 圖示，然後按一下 [**檔案總管] 中的檢視**。
