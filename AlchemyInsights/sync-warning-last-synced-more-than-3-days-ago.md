...
您可以依照 [ [查看目錄同步處理狀態](https://docs.microsoft.com/office365/enterprise/view-directory-synchronization-status)] 中的指示，在 Office 管理員入口網站中檢查 [同步處理狀態]。
