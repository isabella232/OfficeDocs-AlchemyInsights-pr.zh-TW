...
- 從[群組設定](https://admin.microsoft.com/Adminportal/Home?source=applauncher#/SettingsMultiPivot/:/Settings/L1/O365Groups)開啟 [讓群組擁有者將貴組織外部的人員新增到群組]。 如需詳細資訊，請參閱[控制 Microsoft 群組的來賓存取](https://docs.microsoft.com/microsoftteams/teams-dependencies#control-guest-access-in-office-365-groups)。
