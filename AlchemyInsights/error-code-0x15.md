...
|**登錄機碼**|**Type**|**Value**|
|:-----|:-----|:-----|
|HKEY_CURRENT_USER\Software\Microsoft\Office\15.0\Common\Identity\EnableADAL  <br/> |REG_DWORD  <br/> |一級  <br/> |
...
> [!NOTE]
>  在 Office 365 專業增強版和 Office 2016 中, 預設會啟用 ADAL。 > 遠端桌面服務 (RDS) 先前名為終端機服務。
