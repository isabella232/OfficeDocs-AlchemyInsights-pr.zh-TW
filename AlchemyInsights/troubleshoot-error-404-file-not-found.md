...
新式網站 （群組連線的通訊或其他網站） 中新的 SharePoint 系統管理中心存在，請參閱[檢視並還原已刪除的網站中新的 SharePoint 系統管理中心](https://docs.microsoft.com/en-us/sharepoint/restore-deleted-site-collection)。
