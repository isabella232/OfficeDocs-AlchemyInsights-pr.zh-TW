...
[群組深入解析](https://support.office.com/article/view-group-insights-in-yammer-73f9fa6d-d442-4f25-9194-d5317c9328ab)可協助群組管理員和成員深入了解其群組中的活動和互動。 系統管理員可以在 Microsoft 365 系統管理中心存取 [Yammer 活動報告](https://docs.microsoft.com/office365/admin/activity-reports/yammer-activity-report)。 若要取得深入的分析，[適用於 Power BI 的 Microsoft 365 內容套件](https://docs.microsoft.com/office365/admin/usage-analytics/enable-usage-analytics)可啟用自訂報告。
