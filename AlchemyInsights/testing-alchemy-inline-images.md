...
ms.locfileid: "36507154"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="bfc3a-102">存取 [網域] 頁面</span><span class="sxs-lookup"><span data-stu-id="bfc3a-102">Access the Domains Page</span></span>

<span data-ttu-id="bfc3a-103">若要存取 [網域] 頁面上，只要按一下此圖示下方：</span><span class="sxs-lookup"><span data-stu-id="bfc3a-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="bfc3a-104">然後您可以新增、 修改或移除您的網域。</span><span class="sxs-lookup"><span data-stu-id="bfc3a-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="bfc3a-105">如需詳細資訊，請參閱[網域的常見問題集。](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="bfc3a-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
