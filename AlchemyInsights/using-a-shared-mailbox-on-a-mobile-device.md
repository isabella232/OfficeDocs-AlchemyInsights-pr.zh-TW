...
ms.locfileid: "37122133"
---
# <a name="using-a-shared-mailbox-on-a-mobile-device"></a>在行動裝置上使用共用的信箱

若要在行動裝置上使用共用的信箱，您應該[下載 Outlook 行動裝置](https://products.office.com/en-us/outlook-mobile-for-android-and-ios)，然後[新增至 Outlook 行動裝置共用信箱](https://support.office.com/en-us/article/Add-a-shared-mailbox-to-Outlook-mobile-f866242c-81b2-472e-8776-6c49c5473c9f)。
