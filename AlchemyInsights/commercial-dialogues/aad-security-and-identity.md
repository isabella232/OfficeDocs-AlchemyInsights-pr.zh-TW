...
- **Azure Active Directory Connect** [Sync 使用者至您的目錄](https://go.microsoft.com/fwlink/?linkid=2071310) 設定密碼雜湊同步處理或透過驗證，讓您的使用者可以使用相同的密碼，登入電子郵件和內部部署 Active Directory (網域控制站) 。 您也可以使用 Active Directory Federation Services (AD FS) 設定同盟登入。
