...
ms.locfileid: "50735993"
---
# <a name="enable-the-audit-log"></a>啟用稽核記錄

通訊合規性需要「審核記錄檔」顯示提醒，並追蹤檢閱者採取的修復動作。 「審核記錄檔」是與定義之組織原則相關聯的所有活動摘要，包括任何隨通相容性原則變更的事件。 若要開啟審核記錄：

1. 在 [[安全性 & 規範中心](https://go.microsoft.com/fwlink/?linkid=2101341)] 中，移至 [**搜尋**  >  **審核記錄搜尋**]。
2. 選取 [ **開啟審計**]。

    在您開啟審核後，會顯示一則訊息，指出已準備好審核記錄，而且您可以在準備完成後數小時執行搜尋。 您只需執行這項動作一次。
