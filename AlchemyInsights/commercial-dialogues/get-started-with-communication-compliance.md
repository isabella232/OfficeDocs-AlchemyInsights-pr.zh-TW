...
* Office 365 企業版 E3 訂閱 + Office 365 Advanced 合規性附加元件 (已無法再供新訂閱使用，請參閱記事) 
    ...
    > [!NOTE]
    > 如果您沒有現有的 Office 365 企業版 E5 計畫，而且想要嘗試擁有者風險管理，您可以 [將 Microsoft 365 新增](https://go.microsoft.com/fwlink/?linkid=2130508) 至現有的訂閱，或註冊 Office 365 Enterprise E5 的試用版。
