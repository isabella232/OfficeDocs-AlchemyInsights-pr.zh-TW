...
商務用 Skype 網域 (DNS) 設定中的 NS、CNAME 或 SRV 記錄設定不正確。 若要詳細指示，請參閱[在任一 DNS 主機服務提供者建立 DNS 記錄](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)。
