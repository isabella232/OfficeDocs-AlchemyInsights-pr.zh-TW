...
- 郵件流程規則的一般概觀： [Mail flow 規則 （傳輸規則） 在 [Exchange Online](https://technet.microsoft.com/library/jj919238.aspx)
    
- 設定郵件流程規則： [Mail flow 規則程序在 Exchange Online](https://technet.microsoft.com/library/dn600436.aspx)
