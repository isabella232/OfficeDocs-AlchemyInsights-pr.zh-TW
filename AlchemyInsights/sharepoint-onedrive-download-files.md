...
---
# <a name="download-or-prevent-download-of-files-from-onedrive-or-sharepoint"></a>下載或防止下載的檔案從 OneDrive 或 SharePoint

您可以下載的檔案和資料夾從 OneDrive 或 SharePoint Online 到您的電腦具有幾按鍵。 如需有關如何下載檔案的詳細資訊，速度和限制的下載項目請瀏覽下列連結。
