...
ms.locfileid: "43743120"
---
# <a name="change-the-look-of-your-outlook-mailbox"></a>變更 Outlook 信箱的外觀

您可以變更郵寄清單和讀取窗格的外觀，使它看起來和行為您想要的方式。 選擇您的郵件應該個別顯示或交談，如果新郵件應該出現在郵寄清單的頂端或底端，等等。
...
1. 在郵寄清單的頂端，選取 [**篩選** > **排序依據**]，以選擇要如何排序電子郵件。

若要深入瞭解，請參閱[變更信箱的外觀](https://support.office.com/article/b41c2ecb-f23c-42b3-b7f8-659646d5e58c)。